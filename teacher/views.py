...
def loginTeacher(request):
    ...
    return render(request, 'log-reg.html',{'page':page})
...
def teachers(request):
    ...
    if 'search_query' in request.GET:
        ...
        children = Child.objects.filter(name__icontains=search_query, teach=teacher)
    else:
        children = Child.objects.filter(teach=teacher)
